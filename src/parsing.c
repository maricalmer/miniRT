...
void	parsing(t_data *data)
{
	...
	// t_sphere		*sph_10;
	t_plane			*pl_1;
	t_camera		cam = {90, {0, 1.7, 20}, {0,0,-1}};
	...
	t_light lgt_1_data = {0.6, {0,0, 3}, {255, 255, 255}};
	t_plane pl_2_data = {{2, 0, 0}, {-1, 0, 0}};
	t_plane pl_3_data = {{-2, 0, 0}, {1, 0, 0}};
