...
void	parsing(t_data *data)
{
	...
	t_sphere sph_2_data = {{-3, 0.5, 0}, 0.5};
	t_sphere sph_3_data = {{-2, 0.5, 0}, 0.5};
	t_sphere sph_4_data = {{-1, 0.5, 0}, 0.5};
	t_sphere sph_5_data = {{1, 0.5, 0}, 0.5};
	t_sphere sph_6_data = {{2, 0.5, 0}, 0.5};
	t_sphere sph_7_data = {{3, 0.5, 0}, 0.5};
	t_sphere sph_8_data = {{4, 0.5, 0}, 0.5};




	t_plane pl_1_data = {{0, 0, 0}, {0, 1, 0}};
	t_light lgt_1_data = {0.8, {2, 5.5, 20}, {255.0/255, 255.0/255, 255.0/255}};
	t_light lgt_2_data = {0.4, {-5, 8, 5}, {255.0/255, 255.0/255, 255.0/255}};
	...
	data->objects[0].mat.refl_coeff = 0.9;
	...
	data->objects[2].mat.rgb[1] = 0;
	data->objects[2].mat.rgb[2] = 0;
	data->objects[2].mat.refl_coeff = 0;
	...
	data->objects[3].mat.refl_coeff = 0;

	data->objects[4].type = SPHERE;
	data->objects[4].geo = sph_4;
	data->objects[4].mat.rgb[0] = 0;
	data->objects[4].mat.rgb[1] = 0;
	data->objects[4].mat.rgb[2] = 230;
	data->objects[4].mat.refl_coeff = 0;
