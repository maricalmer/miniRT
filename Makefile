...
SOURCES += $(SOURCES_DIRECTORY)/intersection_tests/aabb_SIMD_shadow.c
SOURCES += $(SOURCES_DIRECTORY)/intersection_tests/aabb_SIMD2.c
...
SOURCES += $(SOURCES_DIRECTORY)/math/dot_33.c
