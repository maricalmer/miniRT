...
/*   Updated: 2025/04/26 16:02:55 by dlemaire         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	add_math_tests(void)
{
	...
	if (!CU_add_test(suite, "test_normalize", test_normalize)
		|| !CU_add_test(suite, "test_dot_vec3", test_dot_vec3)
		|| !CU_add_test(suite, "test_vec_subtract", test_vec_subtract)
		|| !CU_add_test(suite, "test_cross_vec3", test_cross_vec3)
